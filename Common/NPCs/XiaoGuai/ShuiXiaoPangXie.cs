...
using System;
using TerraFlipper.Content.Items;
using Terraria;
...
namespace TerraFlipper.Common.NPCs.XiaoGuai
{
	// This ModNPC serves as an example of a completely custom AI.
	public class ShuiXiaoPangXie : ModNPC
	{
		...
		public override void SetStaticDefaults()
		{
			...
			NPCID.Sets.ShimmerTransformToNPC[NPC.type] = NPCID.ShimmerSlime;//微光转化为npcid
		...
		public override void SetDefaults()
		{
			...
			NPC.damage = 16; // The amount of damage that this npc deals
			NPC.defense = 5; // The amount of defense that this npc has
			NPC.lifeMax = 55; // The amount of health that this npc has
			NPC.HitSound = SoundID.NPCHit1; // The sound the NPC will make when being hit.
			NPC.DeathSound = SoundID.NPCDeath1; // The sound the NPC will make when it dies.
			NPC.value = 45f; // How many copper coins the NPC will drop when killed.
		}
		...
		{
			npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<ShuiPangXieJinBi>(),3,1,2));
		}
	}
}