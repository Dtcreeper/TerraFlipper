...
namespace TerraFlipper.Content.ProjectTiles
{
	...
	internal class LiuXingChuiPT : ModProjectile
	{
		...
		public override void SetDefaults()
		{
			...
			Projectile.DamageType = ModContent.GetInstance<ZhiJiDamage>(); // Deals melee damage
		...
		{
			Projectile.type = ModContent.ProjectileType<LiuXingChuiPT>();//本PT的名字
		...
		public override void AI()
		{
			...
			if (Main.rand.Next(1, 15) == 1)
			{
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Main.rand.NextVector2CircularEdge(5, 5), ModContent.ProjectileType<GrayStar_Shui>(), (int)(Main.LocalPlayer.GetTotalDamage<ShuiDamage>().ApplyTo(20) * ZhiJiDamage.JiaCheng() * GongRenDamage.JiaCheng()), 10);
			}
		}
	}
}